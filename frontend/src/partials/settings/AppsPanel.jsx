              ...
              <div className="flex flex-col h-full p-5">
                <div className="grow">
                  <header className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg text-slate-800 font-semibold">SMS 문자 전송</h3>
                  </header>
              ...
              <div className="flex flex-col h-full p-5">
                <div className="grow">
                  <header className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg text-slate-800 font-semibold">카카오톡 비지니스</h3>
                  </header>
                  <div className="text-sm">Lorem ipsum dolor sit amet eiusmod sed do eiusmod tempor.</div>
                </div>
                {/* Card footer */}
              ...
              <div className="flex flex-col h-full p-5">
                <div className="grow">
                  <header className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg text-slate-800 font-semibold">신용카드 결제</h3>
                  </header>
                  <div className="text-sm">KICC 연동</div>
                </div>
                {/* Card footer */}
                <footer className="mt-4">
                  <div className="flex flex-wrap justify-between items-center">
