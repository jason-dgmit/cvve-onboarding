  ...
  return (
    <div className="grow">
      ...
      <div className="p-6 space-y-6">
        <h2 className="text-2xl text-slate-800 font-bold mb-5">내 계정</h2>
        {/* Account Profile */}
        <section>
          <h2 className="text-xl leading-snug text-slate-800 font-bold mb-1">관리자 정보</h2>
          ...
          <div className="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
            ...
            <div className="sm:w-1/2">
              <label className="block text-sm font-medium mb-1" htmlFor="business-id">이메일</label>
