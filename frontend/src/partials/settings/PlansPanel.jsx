          ...
          <div>
           {/* Toggle switch */}
            <div className="flex items-center space-x-3 mb-6">
              <div className="text-sm text-slate-500 font-medium">월간</div>
              ...
              <div className="text-sm text-slate-500 font-medium">연간 <span className="text-emerald-500">(-20%)</span></div>
            </div>
           {/* Pricing tabs */}
