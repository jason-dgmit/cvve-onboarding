  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        ...
        >
          <div className="text-xs font-semibold text-slate-400 uppercase pt-1.5 pb-2 px-4">알림</div>
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              ...
              >
                ...
                <span className="block text-xs font-medium text-slate-400">Dec 12, 2022</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
              ...
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">Edit your information in a swipe</span> Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.</span>
                <span className="block text-xs font-medium text-slate-400">Dec 9, 2022</span>
              </Link>
            </li>
            <li className="border-b border-slate-200 last:border-0">
              <Link
