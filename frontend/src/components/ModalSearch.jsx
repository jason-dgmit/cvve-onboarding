        ...
        <div ref={modalContent} className="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
          ...
          <form className="border-b border-slate-200">
            <div className="relative">
              ...
              <input id={searchId} className="w-full border-0 focus:ring-transparent placeholder-slate-400 appearance-none py-3 pl-10 pr-4" type="search" placeholder="검색" ref={searchInput} />
          ...
          <div className="py-4 px-2">
            ...
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-slate-400 uppercase px-2 mb-2">최근 검색</div>
              <ul className="text-sm">
                ...
                <li>
                  ...
                  >
                    ...
                    <span>Product Update - Q4 2022</span>
                  </Link>
                </li>
                <li>
                  <Link
            ...
            {/* Recent pages */}
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-slate-400 uppercase px-2 mb-2">최근 본 페이지</div>
              <ul className="text-sm">
                <li>
                  <Link
                    className="flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group"
