          ...
          <div className="min-h-screen h-full flex flex-col after:flex-1">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                ...
                이미 계정이 있으십니까? <Link className="font-medium text-indigo-500 hover:text-indigo-600" to="/signin">로그인</Link>
                </div>
              </div>
            ...
            <div className="px-4 py-8">
              <div className="max-w-md mx-auto">
                ...
                <h1 className="text-3xl text-slate-800 font-bold mb-6">사업자정보 ✨</h1>
                {/* htmlForm */}
                <form>
                  <div className="space-y-4 mb-8">
                    {/* 사업자명 */}
                    <div>
                      <label className="block text-sm font-medium mb-1" htmlFor="company-name">사업자명 <span className="text-rose-500">*</span></label>
                      <input id="company-name" className="form-input w-full" type="text" />
                    </div>
                    {/* brn */}
                    <div>
                      <label className="block text-sm font-medium mb-1" htmlFor="company-name">사업자등록번호 <span className="text-rose-500">*</span></label>
                      <input id="company-brn" className="form-input w-full" type="text" />
                    </div>
                    {/* brn */}
                    <div>
                      <label className="block text-sm font-medium mb-1" htmlFor="company-name">대표자명 <span className="text-rose-500">*</span></label>
                      <input id="company-ceo" className="form-input w-full" type="text" />
                    </div>
                    {/* Street Address */}
                    <div>
                      <label className="block text-sm font-medium mb-1" htmlFor="street">주소<span className="text-rose-500">*</span></label>
                      <input id="street" className="form-input w-full" type="text" />
                    </div>
                    {/* City and Postal Code */}
                    <div className="flex space-x-4">
                      <div className="flex-1">
                        <label className="block text-sm font-medium mb-1" htmlFor="city">도시 <span className="text-rose-500">*</span></label>
                        <input id="city" className="form-input w-full" type="text" />
                      </div>
                      <div className="flex-1">
                        <label className="block text-sm font-medium mb-1" htmlFor="postal-code">우편번호 <span className="text-rose-500">*</span></label>
                    ...
                    {/* brn */}
                    <div>
                      <label className="block text-sm font-medium mb-1" htmlFor="company-name">대표번호 <span className="text-rose-500">*</span></label>
                      <input id="company-number" className="form-input w-full" type="number" />
                    </div>
                  </div>
