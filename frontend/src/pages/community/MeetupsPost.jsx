          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
              ...
              <div>
                ...
                <div className="text-sm font-semibold text-indigo-500 uppercase mb-2">Mon 27 Dec, 2022 - 9:00 PM -&gt; 10:00 PM</div>
                  ...
                  <div className="space-y-8 sm:space-y-5 my-6 lg:mb-0">
                    ...
                    <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
                      ...
                      <div className="grow p-5 flex flex-col">
                        <div className='grow'>
                          <div className="text-sm font-semibold text-indigo-500 uppercase mb-2">Mon 27 Dec, 2022</div>
                          <a className="inline-flex mb-2" href="#0">
                            <h3 className="text-lg font-bold text-slate-800">New York &amp; New Jersey Virtual Retreat 2022</h3>
                          </a>
